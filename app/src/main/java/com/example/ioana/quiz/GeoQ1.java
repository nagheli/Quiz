...
public class GeoQ1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_geo_q1);
        ...
        nextQuestion.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // create a new intent to open the GeoQ2 activity
    ...
    private void sendData() {
        ...
        Intent geoQ2Intent = new Intent(GeoQ1.this, GeoQ2.class);
        geoQ2Intent.putExtra("Score", score);

        //START SECOND ACTIVITY
        this.startActivity(geoQ2Intent);
    }
