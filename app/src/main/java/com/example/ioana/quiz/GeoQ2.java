...
public class GeoQ2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_geo_q2);
        ...
        nextQuestion.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // create a new intent to open the GeoQ3 activity
                if (optionFiveQ1.isChecked() || optionThreeQ1.isChecked() || optionTwoQ1.isChecked() || optionOneQ1.isChecked()) {
    ...
    private void sendData() {
        ...
        Intent geoQ3Intent = new Intent(GeoQ2.this, GeoQ3.class);
        geoQ3Intent.putExtra("Score", score);

        //START SECOND ACTIVITY
        this.startActivity(geoQ3Intent);
    }
